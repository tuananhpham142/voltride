...
const ShowcaseContent = () => {
  ...
  const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
    <View style={{ padding: 20, borderBottomWidth: 1, borderBottomColor: colors.border }}>
      <Text style={{ fontSize: 20, fontWeight: '700', color: colors.text, marginBottom: 16 }}>{title}</Text>
      {children}
    </View>
  );
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ padding: 20, alignItems: 'center', backgroundColor: colors.primary }}>
          <Text style={{ fontSize: 32, fontWeight: '700', color: '#FFFFFF' }}>All Components</Text>
        ...
        <Section title='Navigation'>
          ...
          <Text
            onPress={() => {
              navigation.navigate('TripNavigation', { tripId: '1' });
            }}
          >
            TripNavigation
          </Text>
          ...
          <Text
            onPress={() => {
              navigation.navigate('TripDetail', { tripId: '1', autoStart: true });
            }}
          >
            TripDetail Auto Start
          </Text>
          <Text
            onPress={() => {
              navigation.navigate('DeliveryPoint', { deliveryPointId: '1' });
            }}
          >
            DeliveryPoint
          </Text>
          ...
          <Text
            onPress={() => {
              navigation.navigate('PODCapture', { deliveryPointId: '1' });
            }}
          >
            PODCapture
          </Text>
          <Text
            onPress={() => {
              navigation.navigate('CODPayment', { deliveryPointId: '1' });
            }}
          >
            CODPayment
          </Text>
          <Text
            onPress={() => {
              navigation.navigate('QRScanner', { deliveryPointId: '1', onScan: (data: any) => {} });
            }}
          >
            QRScanner
          </Text>
        ...
        <Section title='Control (5)'>
          <View style={{ gap: 12 }}>
            ...
            <Button title='Show Action Sheet' variant='outline' onPress={() => setShowActionSheet(true)} />
          </View>
        </Section>
        ...
        <Section title='Input (10)'>
          <View style={{ gap: 16 }}>
            <Checkbox checked={checked} onChange={setChecked} label='Checkbox Example' />

            <RadioButton selected={radioValue} onSelect={() => setRadioValue((old) => !old)} />

            <Toggle value={toggleValue} onValueChange={setToggleValue} />

            <TextField label='Text Field' value={textValue} onChangeText={setTextValue} placeholder='Enter text...' />
            ...
            <View>
              <Text style={{ fontSize: 14, color: colors.text, marginBottom: 8 }}>Star Rating: {rating}/5</Text>
              <StarRating rating={rating} onChange={setRating} size={32} />
            </View>

            <View>
              <Text style={{ fontSize: 14, color: colors.text, marginBottom: 8 }}>Slider: {sliderValue}</Text>
              <Slider value={sliderValue} onChange={setSliderValue} min={0} max={100} />
            </View>

            <NumberInput label='Number Input' value={numberValue} onChange={setNumberValue} />
            ...
            <SearchBar value={searchValue} onChangeText={setSearchValue} placeholder='Search...' />
          </View>
        </Section>
        ...
        <Section title='Informative (5)'>
          <View style={{ gap: 12 }}>
            ...
            <Banner visible description='This is an info banner' type='info' onDismiss={() => {}} />
        ...
        <Section title='Content (7)'>
          <View style={{ gap: 16 }}>
            ...
            <Accordion title='Accordion Title' initiallyExpanded={true}>
        ...
        <Section title='Progress (4)'>
          <View style={{ gap: 16 }}>
            ...
            <View>
              <Text style={{ fontSize: 14, color: colors.text, marginBottom: 8 }}>Progress: {progressValue}%</Text>
        ...
        <Section title='Chat (2)'>
          <View style={{ gap: 12 }}>
            <MessageBubble message='Hello! This is a received message.' timestamp='10:30 AM' senderName='John' />

            <MessageBubble message='This is my sent message!' timestamp='10:31 AM' status='read' />
        ...
        <Section title='Map & Commerce (3)'>
          <View style={{ gap: 16 }}>
            <Map center={{ latitude: 37.78825, longitude: -122.4324 }} zoom={12} style={{ height: 200 }} />
        ...
        <Section title='Device (2)'>
          <View style={{ gap: 12 }}>
            <Button title='Show Overlay' variant='outline' onPress={() => setShowOverlay(true)} />
        ...
        <Section title='Advanced - Bottom Sheets (4)'>
          <View style={{ gap: 12 }}>
            ...
            />
            <Button title='List Bottom Sheet' variant='secondary' onPress={() => listSheetRef.current?.expand()} />
            <Button title='Form Bottom Sheet' variant='secondary' onPress={() => formSheetRef.current?.expand()} />
            <Button title='Search Bottom Sheet' variant='secondary' onPress={() => searchSheetRef.current?.expand()} />
          </View>
        </Section>
        ...
        <Section title='Advanced - Modals (4)'>
          <View style={{ gap: 12 }}>
            <Button title='Standard Modal' variant='secondary' onPress={() => setShowModal(true)} />
            <Button title='Confirmation Modal' variant='secondary' onPress={() => setShowConfirmModal(true)} />
            <Button
            ...
            />
            <Button title='Image Viewer' variant='secondary' onPress={() => setShowImageModal(true)} />
          </View>
        </Section>
        ...
        <Section title='Advanced - Toast System (3)'>
          <View style={{ gap: 12 }}>
            ...
            />
            <Button title='Show Snackbar' variant='outline' onPress={() => setShowSnackbar(true)} />
          </View>
        </Section>
        ...
        <Section title='Advanced - Pickers (4)'>
          <View style={{ gap: 16 }}>
            <ImagePicker images={selectedImages} onImagesSelected={setSelectedImages} maxImages={3} />

            <FilePicker files={selectedFiles} onFilesSelected={setSelectedFiles} maxFiles={2} />

            <ColorPicker color={selectedColor} onChange={setSelectedColor} showInput />

            <View>
              <Text style={{ fontSize: 14, color: colors.text, marginBottom: 8 }}>OTP Input:</Text>
              <OTPInput length={6} value={otpValue} onChange={setOtpValue} autoFocus={false} />
            </View>
          </View>
        </Section>
          ...
          <View style={{ gap: 16 }}>
            ...
            <Carousel
              ...
              renderItem={(item) => (
                ...
                >
                  <Text style={{ color: '#FFF', fontSize: 20, fontWeight: '700' }}>Slide {item.id}</Text>
                </View>
              )}
              showPagination
            />
        ...
        <Section title='Extra - Utilities (6)'>
          <View style={{ gap: 16 }}>
            <EmptyState icon='inbox' title='Empty State' description='No items found' />

            <RatingReview rating={4.5} totalReviews={234} showBreakdown breakdown={[100, 80, 30, 15, 9]} />
            ...
            <ChipInput chips={chips} onChange={setChips} placeholder='Add tag...' />
            ...
            <View style={{ flexDirection: 'row', gap: 20, alignItems: 'center' }}>
              ...
              <Button title='Reset Badge' variant='outline' size='sm' onPress={() => setNotifCount(0)} />
            </View>
          </View>
        </Section>
        ...
        <View style={{ padding: 40, alignItems: 'center' }}>
          <Text style={{ fontSize: 24, fontWeight: '700', color: colors.text }}>🎉 All 78 Components!</Text>
      ...
      {/* Modals */}
      <EnhancedModal visible={showModal} onDismiss={() => setShowModal(false)} title='Modal' showCloseButton>
      ...
      {showOverlay && (
        <Overlay visible={showOverlay} onDismiss={() => setShowOverlay(false)}>
          <View style={{ padding: 20, backgroundColor: colors.surface, borderRadius: 12 }}>
            <Text style={{ color: colors.text, fontSize: 18, marginBottom: 12 }}>Overlay Content</Text>
